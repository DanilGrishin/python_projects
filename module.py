...
!wget https://github.com/DanilGrishin/python_projects/raw/main/coordinates.xlsx -O coordinates.xlsx
!wget https://github.com/DanilGrishin/python_projects/raw/main/model -O model
